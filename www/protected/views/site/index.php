...
$this->Widget('application.extensions.jsTree.CjsTree', array(
    ...
    'data' => array(
        ...
        'opts' => array(
            'method'=>'GET',
            'async'=>true,
            'url' => $this->createUrl('tree/render'),
    ...
    'callback'=>array(
        ...
        'onmove'=>'js:function(NODE, REF_NODE, TYPE, TREE_OBJ, RB) {
            var mv=false;
            $.ajax({
                url: "'.$this->createUrl('tree/movenode').'" ,
                global: false,
                type: "GET",
                async: false,
        ...
        'onrename'=>'js:function(NODE, TREE_OBJ, RB)  {
            var rnm=false;
            $.ajax({
                url: "'.$this->createUrl('tree/renamenode').'" ,
                global: false,
                type: "GET",
                async: false,
        ...
        'ondelete'=>'js:function(NODE, TREE_OBJ,RB) {
            ...
            if( prompt ) {
                $.ajax({
                    url: "'.$this->createUrl('tree/deletenode').'" ,
                    global: false,
                    type: "GET",
                    async: false,
                    data: ({id : NODE.id }),
        ...
        'oncreate'=>'js:function(NODE, REF_NODE, TYPE, TREE_OBJ, RB) {
                var crt=false;
                $.ajax({
                    url: "'.$this->createUrl('tree/createnode').'" ,
                    global: false,
                    type: "GET",
                    async: false,
        ...
        'oncopy'=>'js:function(NODE, REF_NODE, TYPE, TREE_OBJ, RB) {
            var cp=false;
            $.ajax({
                url: "'.$this->createUrl('tree/copynode').'" ,
                global: false,
                type: "GET",
                async: false,
                data: ({id : NODE.id , ref_id : REF_NODE.id , type: TYPE }),
...
echo CHtml::ajaxButton("Create root",$this->createurl('tree/createroot'), array ('global'=>false,
                    'type' => "GET",
